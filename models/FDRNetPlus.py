...
class convd(nn.Module): #conv-relu
...
class FDRNetPlus(nn.Module):
    def __init__(self):
        ...
        # fuse res
        self.prior = Prior_Sp(self.channel) 
        self.prior2 = Prior_Sp(self.channel) 
        self.prior3 = Prior_Sp(self.channel) 
